      ...
      <section className="relative flex items-center bg-[#07111F] border-b border-[#16324F] px-4 sm:px-6 lg:px-12 py-16 sm:py-20">
        <div className="max-w-4xl mx-auto w-full text-center space-y-6">
          ...
          <p className="text-base sm:text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed font-normal">
            Screen packaged commodity labels against mandatory Rule 6 declarations and trace findings back to visual evidence.
          </p>
        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-5 rounded-lg bg-[#0B1F3A] border border-[#16324F] space-y-2">
              ...
              <h3 className="text-xs font-bold text-white">Automated Extraction</h3>
              <p className="text-[11px] text-slate-400 leading-relaxed">
                RapidOCR reads raw text and coordinates without manual typing.
              </p>
            </div>

            <div className="p-5 rounded-lg bg-[#0B1F3A] border border-[#16324F] space-y-2">
              <ClipboardDocumentCheckIcon className="w-5 h-5 text-[#38BDF8]" />
              <h3 className="text-xs font-bold text-white">Rule 6 Screening</h3>
              <p className="text-[11px] text-slate-400 leading-relaxed">
                Screens MRP, Net Qty, Dates, Packer info against statutory standards.
              </p>
            </div>

            <div className="p-5 rounded-lg bg-[#0B1F3A] border border-[#16324F] space-y-2">
              <EyeIcon className="w-5 h-5 text-[#38BDF8]" />
              <h3 className="text-xs font-bold text-white">Visual Evidence Grounding</h3>
              <p className="text-[11px] text-slate-400 leading-relaxed">
                Every extracted finding maps to bounding box coordinates on the package image.
              </p>
            </div>

            <div className="p-5 rounded-lg bg-[#0B1F3A] border border-[#16324F] space-y-2">
              <ShieldCheckIcon className="w-5 h-5 text-[#38BDF8]" />
              <h3 className="text-xs font-bold text-white">Human Review</h3>
              <p className="text-[11px] text-slate-400 leading-relaxed">
                Ambiguous or missing declarations flag authorized officers for decision-making.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-14 bg-[#0B1F3A] text-white px-4 sm:px-6 lg:px-12 border-b border-[#16324F]">
        <div className="max-w-4xl mx-auto space-y-6 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md text-xs font-semibold bg-[#10263F] text-emerald-400 border border-[#16324F]">
            ...
            <span>Built for Inspection Workflows</span>
          </div>

          <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight">
            Designed for Regulatory Officers & Compliance Teams
          </h2>

          <p className="text-xs sm:text-sm text-slate-300 max-w-xl mx-auto leading-relaxed">
            LabelLens AI serves as a first-level decision support tool. Final enforcement determinations remain with authorized officers under Legal Metrology Act, 2009.
          </p>
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-3">
            ...
            >
              <span>Read Scope & Legal Limitations →</span>
            </button>
          </div>
        </div>
      </section>
