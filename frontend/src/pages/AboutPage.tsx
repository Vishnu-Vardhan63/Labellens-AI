...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-[#07111F] text-slate-100 pb-24">
      {/* Hero Header */}
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-slate-300 leading-relaxed mb-4">
                Under the <strong className="text-white">Legal Metrology Act, 2009</strong> and the{' '}
                <strong className="text-white">Legal Metrology (Packaged Commodities) Rules, 2011</strong>, pre-packaged commodities
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                <div className="p-3.5 rounded-xl bg-[#10263F]/90 border border-white/10">
                  <strong className="text-white block mb-1">Rule 6(1)(a) – Commodity Name</strong>
                  <span className="text-slate-400">Generic or common name of the commodity contained in package.</span>
                </div>
                <div className="p-3.5 rounded-xl bg-[#10263F]/90 border border-white/10">
                  <strong className="text-white block mb-1">Rule 6(1)(b) – Manufacturer / Packer</strong>
                  <span className="text-slate-400">Full name, registered office address, and country of origin if imported.</span>
                </div>
                <div className="p-3.5 rounded-xl bg-[#10263F]/90 border border-white/10">
                  <strong className="text-white block mb-1">Rule 6(1)(c) – Net Quantity</strong>
                  <span className="text-slate-400">Declared in standard units of weight, volume, or count with units.</span>
                </div>
                <div className="p-3.5 rounded-xl bg-[#10263F]/90 border border-white/10">
                  <strong className="text-white block mb-1">Rule 6(1)(d) & (e) – MRP & Dates</strong>
                  <span className="text-slate-400">Maximum Retail Price (incl. of all taxes) and month/year of manufacture.</span>
                </div>
              </div>
            </div>
          </div>
